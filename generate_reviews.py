...
REVIEWS = [
    ...
    ("namyangju-review-02", "남양주시", "아파트 가정폐기물 처리", "가정폐기물처리", "아파트에 쌓여 있던 생활가구와 잔짐을 정리한 현장"),
    ("ansan-review-02", "안산시", "원룸 이사폐기물 처리", "이사폐기물처리", "이사 후 남은 가구와 박스류를 정리한 현장"),
    ("anyang-review-02", "안양시", "주거공간 쓰레기집청소", "쓰레기집청소", "생활폐기물이 쌓인 주거공간을 단계적으로 정리한 현장"),
    ("pyeongtaek-review-02", "평택시", "단독주택 가정폐기물 처리", "가정폐기물처리", "단독주택 내부 생활폐기물과 대형가구를 정리한 현장"),
    ("gimpo-review-02", "김포시", "상가 폐업폐기물 처리", "폐업폐기물처리", "상가 폐업 후 남은 집기와 폐기물을 처리한 현장"),
    ("goyang-review-03", "고양시", "아파트 이사폐기물처리", "이사폐기물처리", "이사 당일 남은 대형가구와 생활잡화를 엘리베이터 동선에 맞춰 반출한 현장"),
    ("yongin-review-03", "용인시", "빌라 이사폐기물처리", "이사폐기물처리", "엘리베이터 없는 빌라에서 이사 후 남은 가구와 박스류를 계단 반출한 현장"),
    ("namyangju-review-03", "남양주시", "주택 이사폐기물처리", "이사폐기물처리", "주택 이사 전후 남은 장롱·침대·생활폐기물을 마당 동선으로 정리한 현장"),
    ("uijeongbu-review-02", "의정부시", "원룸 이사폐기물처리", "이사폐기물처리", "원룸 이사 후 매트리스·책상·생활잡화를 빠르게 반출한 현장"),
    ("siheung-review-02", "시흥시", "아파트 이사폐기물처리", "이사폐기물처리", "아파트 이사 후 남은 소파·가전·잔짐을 지하 주차장 동선으로 반출한 현장"),
    ("hanam-review-02", "하남시", "아파트 생활폐기물처리", "생활폐기물처리", "베란다·창고에 쌓인 생활폐기물과 쓰지 않는 가구를 분리 반출한 현장"),
    ("gwangmyeong-review-02", "광명시", "주택 생활폐기물처리", "생활폐기물처리", "주택 내부 생활잡화·낡은 가전·잔짐을 종류별로 나눠 반출한 현장"),
    ("uiwang-review-02", "의왕시", "아파트 생활폐기물처리", "생활폐기물처리", "이사 없이 집 정리 중 나온 생활폐기물과 잔짐을 정리한 현장"),
    ("gwacheon-review-02", "과천시", "원룸 생활폐기물처리", "생활폐기물처리", "원룸에 쌓인 생활용품·박스·소형가구를 분리해 반출한 현장"),
    ("yangju-review-02", "양주시", "단독주택 생활폐기물처리", "생활폐기물처리", "단독주택 창고·마당에 쌓인 생활폐기물과 오래된 물품을 정리한 현장"),
]
